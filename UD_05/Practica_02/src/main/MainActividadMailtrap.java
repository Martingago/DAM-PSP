...
public class MainActividadMailtrap {

    public static void main(String[] args) {
        System.out.println("Ejecutando MAILTRAP");
        //Credenciales para la cuenta de GMAIL
        String username = "5b8f131161c89b"; 
        String password = "bb72666f617645";
        ...
        try {
            props.load(new FileInputStream("./smtp.mailtrap.properties"));
        } catch (IOException e) {
