...
public class Ejercicio1 {
    public static void main(String[] args){
       ...
       //Proceso1 
       ProcessBuilder pb1 = new ProcessBuilder("java", "ejercicio1.MiProcessBuilder", "10", "20", "1500");
       pb1.redirectOutput(ProcessBuilder.Redirect.appendTo(f1));
       pb1.redirectError(ProcessBuilder.Redirect.appendTo(f1)
        );
       //Proceso2
       ProcessBuilder pb2 = new ProcessBuilder("java", "ejercicio1.MiProcessBuilder", "10", "20", "300"); 
